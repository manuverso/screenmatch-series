...
public class Principal {
    ...
    private static final String API_KEY = "&apikey=d69cc1e2";
    ...
    private void buscarSeriePorTitulo() {
        System.out.println("Digite o título da série a ser buscada: ");
        var nomeSerie = leitura.nextLine();
    ...
    private void buscarSeriePorAtor() {
        System.out.println("Qual o ator para a busca?");
        var nomeAtor = leitura.nextLine();
        System.out.println("A partir de qual valor as avaliações? ");
    ...
    private void buscarPorCategoria() {
        ...
        Categoria categoria = Categoria.fromPortuga(categoriaSerie);
    ...
    private void buscarEpisodioPorTrecho() {
        System.out.println("Digite o trecho do episódio a ser buscado: ");
        var trechoEpisodio = leitura.nextLine();
        List<Episodios> episodioBuscado = repositorio.episodiosPorTrecho(trechoEpisodio);
